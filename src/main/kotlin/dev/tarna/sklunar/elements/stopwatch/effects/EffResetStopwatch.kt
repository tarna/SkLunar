...
class EffResetStopwatch : Effect() {
    companion object {
        init {
            Skript.registerEffect(EffResetStopwatch::class.java, "reset [the] [lunar] stopwatch for %players%")
        }
    }
    ...
    override fun execute(event: Event) {
        ...
        stopwatchModule.resetStopwatch(Recipients.of(players.toList().toApollo()))
    }
