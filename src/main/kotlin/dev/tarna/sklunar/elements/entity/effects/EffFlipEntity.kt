...
class EffFlipEntity : Effect() {
    companion object {
        init {
            Skript.registerEffect(EffFlipEntity::class.java, "flip %entities% for %players%")
        }
    }
    ...
    override fun execute(event: Event) {
        ...
        entityModule.flipEntity(recipients, entities.map { ApolloEntity(it.entityId, it.uniqueId) })
    }
